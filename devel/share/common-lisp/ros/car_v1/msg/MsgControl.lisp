...
(cl:defmethod cl:initialize-instance :after ((m <MsgControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car_v1-msg:<MsgControl> is deprecated: use car_v1-msg:MsgControl instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <MsgControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_v1-msg:data-val is deprecated.  Use car_v1-msg:data instead.")
  (data m))

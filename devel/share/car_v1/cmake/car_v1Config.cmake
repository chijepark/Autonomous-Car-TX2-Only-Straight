...
if(NOT "/home/nvidia/aces_car/v1/devel/include;/home/nvidia/aces_car/v1/src/car_v1/include " STREQUAL " ")
  set(car_v1_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/aces_car/v1/devel/include;/home/nvidia/aces_car/v1/src/car_v1/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'car_v1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/aces_car/v1/src/car_v1/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/aces_car/v1/devel/lib;/opt/ros/kinetic/lib)
